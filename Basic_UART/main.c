/*
 * This program is a basic echo sketch using USART2 for the STM32F407VG board.
 ...
 * Check status register flags to see when data or transmit register are empty
 *
 * Author: Jerome Samuels-Clarke
 * Website: www.jscblog.com
 * Last Modified 21/11/20
 */
